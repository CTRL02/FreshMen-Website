...
let add = () => {
    ...
    function check1(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('appArea1', text.value)  ;          
    ...
    function check2(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('appArea2', text.value)  ;          
    ...
    function check3(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('appArea3', text.value)  ;          
    ...
    function check4(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('appArea4', text.value)  ;          
    ...
    function check5(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('appArea5', text.value)  ;          
            
        }
    }

    if(localStorage.getItem('appArea1') !== null)
{
    document.getElementById('1').value = localStorage.getItem('appArea1') ;
}
if(localStorage.getItem('appArea5') !== null)
{
    document.getElementById('4').value = localStorage.getItem('appArea5') ;
}
if(localStorage.getItem('appArea3') !== null)
{
    document.getElementById('2').value = localStorage.getItem('appArea3') ;
}
if(localStorage.getItem('appArea4') !== null)
{
    document.getElementById('3').value = localStorage.getItem('appArea4') ;
}
if(localStorage.getItem('appArea2') !== null)
{
    document.getElementById('5').value = localStorage.getItem('appArea2') ;
}
