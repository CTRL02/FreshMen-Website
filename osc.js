...
let add = () => {
    ...
    function check1(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('oArea1', text.value)  ;          
    ...
    function check2(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('oArea2', text.value)  ;          
    ...
    function check3(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('oArea3', text.value)  ;          
    ...
    function check4(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('oArea4', text.value)  ;          
    ...
    function check5(){
        ...
        if(amr)
        {
            ...
            localStorage.setItem('oArea5', text.value)  ;          
            
        }
    }

    if(localStorage.getItem('oArea1') !== null)
{
    document.getElementById('1').value = localStorage.getItem('oArea1') ;
}
if(localStorage.getItem('oArea5') !== null)
{
    document.getElementById('4').value = localStorage.getItem('oArea5') ;
}
if(localStorage.getItem('oArea3') !== null)
{
    document.getElementById('2').value = localStorage.getItem('oArea3') ;
}
if(localStorage.getItem('oArea4') !== null)
{
    document.getElementById('3').value = localStorage.getItem('oArea4') ;
}
if(localStorage.getItem('oArea2') !== null)
{
    document.getElementById('5').value = localStorage.getItem('oArea2') ;
}